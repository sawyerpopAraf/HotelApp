...
begin
    ...
    select @roomId1 = Id from dbo.RoomTypes where Price = 100;
    select @roomId2 = Id from dbo.RoomTypes where Price = 115;
    select @roomId3 = Id from dbo.RoomTypes where Price = 205;
